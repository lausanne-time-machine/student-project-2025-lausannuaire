...
```js
const mydata = await FileAttachment("./data/1901_prompt_based_classification_results_lausanne_all_persons_v2_normalized.csv").csv()
...
const registre = await FileAttachment("./data/1901_prompt_based_classification_results_lausanne_all_persons_v2_normalized.csv").csv()
